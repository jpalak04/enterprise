...
import { Content, Header, HeaderLabel, LinkButton, Page } from '@backstage/core-components';
...
export const DeploymentCard = () => (
    <Page themeId="tool">
    <Header title="Cloud Engineering Deployment" subtitle="Manage and Deploy Applications">
